...
import {User} from '../users/users-management/user-create-update/user.model';
import {ListDataSource} from '../../core/list/list-datasource';
import {ListDatabase} from '../../core/list/list-database';
import {MatPaginator, MatSort} from '@angular/material';
import {USERS_DATA} from '../users/users-management/users.demo';
...
export class AggregationsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    // this.aggregations = USERS_DATA.map(user => new User(user));
    // this.subject$.next(this.users);
    this.data$ = this.aggService.getAggregations();
